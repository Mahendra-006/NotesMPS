    ...
    <>
      ...
      <div className='container mx-auto'>
        {allNotes.length > 0 ? (<div className='grid grid-cols-3 gap-4 mt-8 '>
          ...
          <EmptyCard message={isSearch? `Oops no note found...` : `Start creating your first note!!! Click on the 'ADD' button to begin your Note making journey. Let's get Started!`}/>
        )}
      </div>
